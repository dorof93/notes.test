        ...
        <div class="section">
            <div class="section__container">
                <div class="workspace">
                    <ul class="tree list">
                        <li class="list__item">
                            <a class="link list__link tree__link_big" href="/">
                                Создать заметку
                            </a>
                        </li>
                        <?php 
                            ...
                            foreach ($tree as $name) {
                                ?>
                                <li class="list__item">
                                    <a class="link list__link tree__link_red link_confirm" data-confirm="Удалить заметку?" href="/?path=<?php echo $name; ?>&del=1">
                                        [x]
                                    </a>
